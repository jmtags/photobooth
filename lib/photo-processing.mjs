...
export function buildPrompt(options) {
  ...
  return [
    ...
    "Keep the full head and hair visible with a small margin above the head.",
    "Center the face horizontally and vertically in the upper-middle of the frame.",
    "Do not crop the top of the head, hair, chin, neck, or shoulders.",
    background,
    attire,
    retouching,
